        ...
        <form action="../sistema/cad.php" method="POST">
            ...
            <div class="-3">
                ...
                <select class="form-control" name="departamentoId" id="idDepartamento">
                    <options>Escolha o departamento</options>
                    <?php
            ...
            <div class="mb-3">
                <label for="idDepartamento" class="form-label">idDepartamento</label>
                <input type="number" class="form-control" name="departamentoid" id="idDepartamento">
            </div>
            <div class="mb-3">
