...
<body>
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="./paginas/novoUsuario.php">Novo Usuario</a></li>
                        <li><a class="dropdown-item" href="./paginas/listarUsuario.php">Listar Usuario</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="./paginas/novoDepartamento.php">Novo Departamento</a></li>
                        <li><a class="dropdown-item" href="./paginas/listarDepartamento.php">Listar Departamento</a></li>
                    </ul>
                </li>                
            </ul>
        </header>
    ...
    <section>
        <h1>Bem Vindos ao Sistema CRUD</h1>
    </section>
    <div class="container">
