        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM usuario AS u INNER JOIN departamento AS d ON u.departamentoID = d.idDpartamento";
                    ...
                    if ($qtd > 0) {
                        while ($row = $res->fetch_object()) {
                            ...
                            echo "<td>
                                <button onclick=\"location.href='editarusuario.php?&id=" .
                                $row->id . "';\" class='btn btn-success'>Editar</button> 
                                <button onclick=\"if(confirm('Tem certeza que deseja excluir?'))
                                {location.href='../sistema/cadusuario.php?&acao=excluir&id=" .
